...
public class IBMMQSinkAdaptorRuntimeException extends RuntimeException {
    ...
    public IBMMQSinkAdaptorRuntimeException(String message) {
        super(message);
    }

    public IBMMQSinkAdaptorRuntimeException(String message, Throwable cause) {
        super(message, cause);
    }

    public IBMMQSinkAdaptorRuntimeException(Throwable cause) {
        super(cause);
    }
}
