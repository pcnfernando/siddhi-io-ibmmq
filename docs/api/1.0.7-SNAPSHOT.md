...
<span id="syntax" class="md-typeset" style="display: block; font-weight: bold;">Syntax</span>
```
@source(type="ibmmq", destination.name="<STRING>", host="<STRING>", port="<STRING>", channel="<STRING>", queue.manager="<STRING>", username="<STRING>", password="<STRING>", worker.count="<INT>", max.retries="<INT>", retry.interval="<INT>", batch.properties="<STRING>", @map(...)))
```
...
<table>
    ...
    <tr>
        <td style="vertical-align: top">max.retries</td>
        <td style="vertical-align: top; word-wrap: break-word">Maximum number of retries to reconnect to the MQ server during a broken connection before giving up.</td>
    ...
    <tr>
        ...
        <td style="vertical-align: top; word-wrap: break-word">Interval between retry attempts in seconds.</td>
